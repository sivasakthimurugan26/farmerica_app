...
class _DashboardState extends State<Dashboard> {
  ...
  List<String> homeScreen = [
    ...
    'assets/images/get-well-soon.jpeg',
    'assets/images/raksha-bandhan-card.jpeg',
                      ...
                      return GestureDetector(
                          onTap: () async {
                            if (homeScreen[index].toString() == 'assets/images/exotic-vegetable-a-gift-basket.jpeg') {
                              ...
                              // response = await api_services.getMultipleCategoryProducts(categoryIds);
                            ...
                            if (homeScreen[index].toString() == 'assets/images/get-well-soon.jpeg') {
                            ...
                            } else if (homeScreen[index].toString() == 'assets/images/raksha-bandhan-card.jpeg') {
