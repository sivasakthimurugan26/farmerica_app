...
class Carousal extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List slides = [
       // 'https://www.farmerica.in/wp-content/uploads/2023/07/raksha-bandhan-offer.jpg',
      ...
      "https://www.farmerica.in/wp-content/uploads/2023/03/Dry-fruits-banner-4.jpg",
    ];
        ...
        items: slides.map((item) {
          return GestureDetector(
            onTap: () async{
              ...
              var response;
              switch(item){
                case 'https://www.farmerica.in/wp-content/uploads/2023/07/raksha-bandhan-offer.jpg':
                  response = await api_services.getProducts(128);
                  Navigator.of(context, rootNavigator: true).push(MaterialPageRoute(
                      builder: (context) => Grocery(
                        product: response,
                      )));
                  break;
                case 'https://www.farmerica.in/wp-content/uploads/2023/03/exotic-vagetable-1.jpg':
                  ...
                  break;
                case 'https://www.farmerica.in/wp-content/uploads/2023/03/fruits-basket-1.jpg':
                  ...
                  break;
                case 'https://www.farmerica.in/wp-content/uploads/2023/03/Dry-fruits-banner-4.jpg':
                  response = await api_services.getProducts(45);
                  Navigator.of(context, rootNavigator: true).push(MaterialPageRoute(
                      builder: (context) => Grocery(
                        product: response,
